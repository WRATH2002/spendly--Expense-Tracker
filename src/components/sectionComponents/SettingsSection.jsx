...
export default function SettingsSection(props) {
  ...
  return (
    <>
      ...
      <div
        className={
          "w-full h-full flex flex-col justify-start items-center overflow-y-scroll  p-[15px] text-[#D4D4D4] text-[14px] font-[geist] select-none" +
      ...
      >
        ...
        <div className="bg-[#ffffff10] w-full min-h-[50px] rounded-t-xl rounded-b-sm flex justify-start items-center">
          <HugeiconsIcon
            icon={UserEdit01Icon}
            size={20}
            strokeWidth={1.7}
        ...
        <div
          className={
            ...
            (props?.accountInfo?.theme ? " bg-[#ffffff]" : " bg-[#ffffff10]")
          }
        >
